...
declare global {
  ...
  const markdownToHtml: typeof import('../../utils/markdownToHtml').markdownToHtml
  ...
  const parseMarkdownList: typeof import('../../utils/frontmatter').parseMarkdownList
...
declare global {
  ...
  // @ts-ignore
  export type { FrontmatterData, ParsedMarkdown } from '../../utils/frontmatter'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly markdownToHtml: UnwrapRef<typeof import('../../utils/markdownToHtml')['markdownToHtml']>
    ...
    readonly parseMarkdownList: UnwrapRef<typeof import('../../utils/frontmatter')['parseMarkdownList']>
